...
\begin{tikzpicture}
  ...
  \path[mindmap,concept color=cyan,text=black]
    ...
    child[grow=235, concept color=red!40] {
      node[concept](PyTor) {PyTorch}
    }
    }   
    child[grow=305,concept color=red!50] { node[concept](Neuro) {Data} 
    child[grow=315,concept color=red!40] { node[concept](NeuroData) {Neuroscience} 
    }
    }
